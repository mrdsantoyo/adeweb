...
df_mesofilicos = dfs.loc[:, ['Folio', 'Producto', 'Fecha de siembra', 'Cta. Total Mesofilicos  <10,000 UFC/g']].copy()
df_coliformes = dfs.loc[:, ['Folio', 'Producto', 'Fecha de siembra', 'Cta. Total Coliformes  <10 UFC/g', 'Cta. Total Coliformes  <5000 UFC/g', 'Cta. Total Coliformes  <5,000 UFC/g', 'Coliformes  <10 UFC/g']].copy()
...
df_coliformes['coliformes'] = df_coliformes['coliformes_1'].combine_first(df_coliformes['coliformes_2']).replace('INC', 220).astype(float)
df_coliformes["Coliformes (<5'000 UFC/g)"] = df_coliformes['coliformes_3'].replace('INC', 10000).astype(float)
# .combine_first(df_coliformes['coliformes_4'])
